...
GlobalConfig::$CONNECTION_SETTING->DBName = "cargo";
...
/** the root url of the application with trailing slash, for example http://localhost/cargo/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'cargo/';
