...
require_once("DAO/CustomerViewCriteriaDAO.php");

/**
 * The CustomerViewCriteria class extends CustomerViewDAOCriteria and is used
 ...
 * @version 1.0
 */
class CustomerViewCriteria extends CustomerViewCriteriaDAO
{
