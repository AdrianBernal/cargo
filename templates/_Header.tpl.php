			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">CARGO</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<li <?php if ($this->nav=='customers') { echo 'class="active"'; } ?>><a href="./customers">Customers</a></li>
								<li <?php if ($this->nav=='customerviews') { echo 'class="active"'; } ?>><a href="./customerviews">CustomerViews</a></li>
								<li <?php if ($this->nav=='packages') { echo 'class="active"'; } ?>><a href="./packages">Packages</a></li>
								<li <?php if ($this->nav=='purchases') { echo 'class="active"'; } ?>><a href="./purchases">Purchases</a></li>
							</ul>
							<ul class="nav">
								<li class="dropdown">
								...
								<li <?php if ($this->nav=='statuscodes') { echo 'class="active"'; } ?>><a href="./statuscodes">StatusCodes</a></li>
								</ul>
								</li>
							</ul>
